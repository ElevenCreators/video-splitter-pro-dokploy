...
useEffect(() => {
  // Limpia lastJobId en cada entrada a la página
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen gap-8 bg-[var(--bg)] text-[var(--fg)] px-4">
      {/* Header con logo + tÃƒÆ’Ã‚Â­tulo nuevo */}
      ...
      <div className="w-full max-w-lg">
        ...
        >
          ...
          <span className="flex items-center justify-center flex-col">
            ...
            {selectedFile && (<div className="mt-2"><p className="text-sm text-green-400 text-center">✅ {selectedFile.name.normalize("NFC")}</p></div>)}
          </span>
        </div>
      </div>
      ...
      {/* Lista de segmentos debajo de la barra */}
	<div className="w-full max-w-lg">
  	<SegmentsInline initialJobId={lastJobId} autoload={false} />
	</div>
